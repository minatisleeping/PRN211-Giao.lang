...
public partial class HoangNgocTrinhContext : DbContext
{
    ...
    //hàm đọc chuỗi kết nối CSDL từ file json: appsettings.json
    //private vì chỉ cần dùng nội bộ class này
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C20756EC3F03");
        ...
        {
            entity.HasKey(e => e.BookCategoryId).HasName("PK__BookCate__6347EC047D82D06A");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__UserAcco__0CF04B18CD5360B0");
